+++
title = "Thirty Days Of Agents: Motivation"
date = 2026-03-23
description = "Learning how to code in an agentic way"
canonical_url = "https://johnnylarner.github.io/thought-repo/blog/thirty-days-of-agents-intro/"
[taxonomies]
tags = ["software", "ai"]
[extra]
copy_button = true
...
1. Large tech companies will be able to maintain monopolies with fewer engineers
2. Engineers who aren't willing to embrace significant change will get left behind
3. Private equity firms with big bets on pre-agentic enterprise software fear loss of market share (white collar jobs replaced by agents)

And so in many ways it is a bittersweet moment for me, accepting that I must and therefore _ought to want to change_. I believe passion, interest and knowledge are not virtues born out of nothing. You have to work hard to cultivate them and that's why I want to share this journey with the wilder world. Our first stop is going to be getting Openclaw up and running. Watch this space.
